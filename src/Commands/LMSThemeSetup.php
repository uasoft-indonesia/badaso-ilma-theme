...
namespace Uasoft\Badaso\Theme\LMSTheme\Commands;
...
class LMSThemeSetup extends Command
{
     ...
     * @var string
     */
    protected $description = 'Setup Badaso LMS Theme';
    ...
    {
        Artisan::call('vendor:publish', ['--tag' => 'BadasoLMSTheme']);

        $this->info('Badaso lms theme provider published');
    }
