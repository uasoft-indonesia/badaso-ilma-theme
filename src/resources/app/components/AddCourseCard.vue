    ...
    >
      ...
      <div class="space-x-2">
        <button
          ...
          @click="createCourse"
        >
          <div class="text-primary font-medium text-sm">Create</div>
        </button>
        <button
          class="bg-primary hover:bg-secondary w-20 p-1 border border-gray-400 rounded shadow"
          elevation="0"
        >
          <div class="text-white font-medium text-sm" id="join-btn">Join</div>
        </button>
      </div>
    </div>
  </v-card>
